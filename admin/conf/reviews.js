$(document).ready(function() {
	...
	if(name.length <= 0 ) $('.show-add-name').css({'border' : '1px solid #ff1302', 'box-shadow' : '0 0 6px 1px #ff1302'});
	else $('.show-add-name').css({'border' : '1px solid #00ff00', 'box-shadow' : '0 0 6px 1px #00ff00'});
	if(email.length <= 0 ) $('.show-add-email').css({'border' : '1px solid #ff1302', 'box-shadow' : '0 0 6px 1px #ff1302'});
	else $('.show-add-email').css({'border' : '1px solid #00ff00', 'box-shadow' : '0 0 6px 1px #00ff00'});
	if(message.length <= 0 ) $('.show-add-message').css({'border' : '1px solid #ff1302', 'box-shadow' : '0 0 6px 1px #ff1302'});
