        ...
        <div class="ajax_editblock">
            ...
            <p class="after">Заголовок сайта:
                <input type="text" name="title" value="" class="ajax_editblock-title input"
                       placeholder="Название для title">
            </p>
            ...
            <p class="after-textarea">Описание сайта: <br>
                <textarea type="text" name="description" placeholder="Ваше описание сайта (не более 65 символов)"
                          class="ajax_editblock-description"></textarea>
            </p>
            <p class="after-textarea">Общий заголовок страниц: <br>
                <textarea type="text" name="og_title" placeholder="Общий заголовок всех страниц (не более 65 символов)"
                          class="ajax_editblock-og_title"></textarea>
            </p>
            <p class="after-textarea">Краткое описание страниц:
                <textarea type="text" name="og_description"
                          placeholder="Краткое описание всех страниц (не более 65 символов)" value=""
                          class="ajax_editblock-og_description"></textarea>
            </p>
            <p class="after-textarea">Ключевые слова для сайта:
                <textarea type="text" name="keywords" placeholder="Слова для поисковиков (не более 10)" value=""
                          class="ajax_editblock-keywords"></textarea>
            </p>
