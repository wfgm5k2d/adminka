        ...
        <div class="ajax_addblock">
            ...
            <div class="tabs-1">
                ...
                <p class="after-textarea">Краткое описание товара:
                    <textarea type="text" name="descript" placeholder="Краткое описание товара"
                              class="ajax_addblock-descript"></textarea>
                </p>
                <p class="after-textarea">Полное описание товара:
                    <textarea type="text" name="content" placeholder="Полное описание товара"
            ...
            <div class="tabs-2">
                ...
                <p class="after">Старая цена товара:
                    <input type="text" name="oldprice" placeholder="Старая цена товара"
                           class="ajax_addblock-oldprice input">
                </p>
    ...
    <div class="editblock">
        ...
        <div class="ajax_editblock">
            ...
            <p class="after">Новое имя товара:
                <input type="text" name="name" placeholder="Новое имя товара" value=""
            ...
            <p class="after">Старая цена товара:
                <input type="text" name="oldprice" placeholder="Старая цена" value=""
                       class="ajax_editblock-oldprice input">
            </p>
            <p class="after">Артикул товара:
