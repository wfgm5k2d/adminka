...
cp "${COMPOSE_PROJECT_DIR}/.docker/scripts/docker-compose-${COMPOSE_PROJECT_NAME}.service" "/etc/systemd/system/docker-compose-${COMPOSE_PROJECT_NAME}.service"
systemctl start "docker-compose-${COMPOSE_PROJECT_NAME}"
